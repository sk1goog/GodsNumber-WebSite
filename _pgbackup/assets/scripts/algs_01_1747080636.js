...
function initSim() {
    ...
    camera.lookAt(0, 0, 0);  // <-- jetzt zeigt die Kamera auf den Ursprung!
    ...
    // Zugfolge anzeigen und Farben anwenden
    ...
    function parseAlgorithm(str) {
        return str.trim().split(/\s+/).map(tok => {
            const face = tok[0];
            const count = tok.endsWith("2") ? 2 : 1;
...
// Direkt ausführen, wenn DOM ready
